  ...
  <div class="max-w-7xl mx-auto px-4">
    <div class="footer-grid grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
      ...
      <div>
        ...
        <p class="text-gray-400 mb-4">
          Penyedia helm berkualitas dengan standar keamanan tinggi sejak 1985, berkomitmen untuk keselamatan pengendara.
        </p>
      ...
      <div>
        ...
        <ul class="space-y-3 text-gray-400">
          <li>
            <a href="#" class="footer-link flex items-center gap-2 hover:text-blue-400">
        ...
        <ul class="space-y-3 text-gray-400">
          <li class="flex items-start">
            ...
            <div>
              ...
              <div>
                <a href="https://wa.me/6281803185594" target="_blank" class="text-blue-400 hover:underline">
                  0818-0318-5594
                </a>
              </div>
              <div class="font-medium">Cak No</div>
              <div>
                <a href="https://wa.me/628155599007341" target="_blank" class="text-blue-400 hover:underline">
                  0815-5990-07341
                </a>
              </div>
            </div>
          </li>
          <!-- Tambahan Email (opsional)
          <li class="flex items-start">
          ...
          <li class="flex items-start">
            ...
            <div>
              ...
              <a href="#" target="_blank" class="text-blue-400 hover:underline hover:text-blue-500 text-sm">
    ...
    <div class="border-t border-gray-800 pt-6 text-center">
      <div class="mb-2 text-sm text-gray-500">
        &copy; 2025 Toko Agus Jaya Helm. All rights reserved. |
