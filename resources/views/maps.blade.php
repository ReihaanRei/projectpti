...
<head>
    ...
    <script>
        function initMap() {
            const location = { lat: -7.2968674, lng: 112.7623556 }; // Contoh koordinat Surabaya
    ...
    <main class="container mx-auto px-4 py-6 flex-grow">
        ...
        <div class="bg-white rounded-lg shadow-md p-4 mt-6 w-2/3 mx-auto text-center">
            ...
            <ul class="list-disc list-inside text-gray-700 text-sm">
                <li><strong>Lokasi Google Maps : </strong><a href="https://maps.app.goo.gl/i74u3zZCicoSvjgq7" target="_blank"
